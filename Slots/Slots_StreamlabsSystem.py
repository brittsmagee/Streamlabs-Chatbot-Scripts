...
def Init():
	...
	try:
		...
		settings = {
			...
			"emoteList": "Kappa, LUL, thebee20BJ, thebee2069, thebee20Lurk, thebee20Heart",
			"superEmote": "thebee20Hit",
			"responseLost": "$user pulls the lever [$slots] and looses $cost $currency thebee20Heart",
			"responseWonSmall": "$user pulls the lever [ $slots ] and wins (x$multiplier) $reward $currency! thebee20BJ",
			"responseWon": "$user pulls the lever [$slots] and wins (x$multiplier) $reward $currency! thebee20Lurk",
			"responseJackpot": "$user pulls the lever [$slots] and hits the Jackpot (x$multiplier) $reward $currency! thebee2069",
			"responseSuperJackpot": "$user pulls the lever [$slots] and hits the SUPER JACKPOT (x$multiplier) $reward $currency! thebee20Hit",
			"useCooldown": True,
